...
$router->addMiddleware(static function (callable $next): void {
...
$router->get('/api/frames', static function (): void {
    header('Content-Type: application/json');
...
$router->get('/api/check-photo', static function (): void {
    header('Content-Type: application/json');
...
$router->get('/api/download-photo', static function (): void {
    try {
...
$router->get('/api/generate-qr', static function (): void {
...
$router->post('/api/save-photo', static function (): void {
...
$router->post('/api/delete-photo', static function (): void {
    if (!CsrfHelper::validateRequest()) {
        http_response_code(403);
        echo json_encode(['success' => false, 'message' => 'Invalid CSRF token']);
        return;
...
$router->post('/api/send-email', static function (): void {
...
$router->get('/api/cleanup-photos', static function (): void {
