...
export class ModalManager {
	...
	init() {
		...
		document
			...
			?.addEventListener("click", () => this.downloadNow());
		document
			.getElementById("btnPrint")
			?.addEventListener("click", () => this.printNow());
		document
			.getElementById("btnEmailAction")
			?.addEventListener("click", () => this.openEmailModal());
		document
			.getElementById("btnQrAction")
			?.addEventListener("click", () => this.openQRModal());
		...
		document
			...
			?.addEventListener("click", () => this.closeQRModal());
		document
			.getElementById("btnCloseEmail")
			?.addEventListener("click", () => this.closeEmailModal());
		document
	...
	async downloadNow() {
		...
		try {
			...
			alert(
				Lang.get("error.prefix") + "Gagal mengunduh foto. Silakan coba lagi.",
			);
		}
	}
	...
	async printNow() {
		...
		try {
			...
			alert(
				Lang.get("error.prefix") +
					"Gagal memuat foto untuk cetak. Silakan coba lagi.",
			);
		}
	}
