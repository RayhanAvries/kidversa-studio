...
export const Lang = {
    id: {
        ...
        infoSavedInCloud: 'Foto ini disimpan secara aman di Kidversa Cloud. Silakan unduh atau pindai kode QR untuk menyimpan kenangan ini langsung di galeri handphone Anda.',
        details: {
        ...
        scanInstruction: 'Arahkan kamera HP Anda ke QR code ini untuk membuka foto ini dan menyimpannya secara instan ke galeri ponsel Anda.',
        kidversaStudio: 'Kidversa Studio',
        jakartaIndonesia: 'Bandung, Jawa Barat',
        expiredMessage: 'Waktu penyimpanan foto ini telah habis (batas maksimal 60 menit). Demi keamanan privasi Anda, semua file foto di Kidversa Studio akan dihapus secara otomatis dari sistem secara berkala.',
        photoNotFoundMessage: 'Maaf, berkas foto yang Anda cari tidak ditemukan. Silakan pastikan tautan sudah benar atau lakukan sesi pengambilan foto baru.',
    ...
    en: {
        ...
        infoSavedInCloud: 'This photo is securely stored in Kidversa Cloud. Please download or scan the QR code to save this memory directly to your phone gallery.',
        details: {
            dateTime: 'Date & Time',
            location: 'Location',
        ...
        scanInstruction: 'Point your phone camera at this QR code to open this photo and instantly save it to your phone gallery.',
        kidversaStudio: 'Kidversa Studio',
        jakartaIndonesia: 'Bandung, Jawa Barat',
        expiredMessage: 'The storage time for this photo has expired (maximum limit of 60 minutes). For your privacy security, all photo files in Kidversa Studio will be automatically deleted from the system periodically.',
        photoNotFoundMessage: 'Sorry, the photo file you are looking for was not found. Please make sure the link is correct or perform a new photo capture session.',
