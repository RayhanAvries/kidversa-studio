        ...
        try {
            ...
            if (this._currentOperation) {
                ...
                if (error.message === 'Upload cancelled') {
                    ...
                    await this.queue.updateStatus(item.id, 'captured');
                    this.onStatusChange(item.id, 'captured');
                    ...
                    await this.queue._updateStatusAndRetries(item.id, 'pending', error.message);
